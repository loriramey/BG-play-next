...
def display_static_visuals():
    ...
    st.image("visualizations/rating_distribution.png", caption="Distribution of Ratings in the Data Set")
    st.write("These ratings are a Bayesian average which moderates the influence of games with only a few reviews.")
    st.markdown("""---""")
